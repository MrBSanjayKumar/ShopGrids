      ...
      <div class="row">
        <div className="col-12 col-md-12 col-lg-6">
          ...
          <form className='form-control1'>
            ...
            <button type='cancel' style={{ padding: '15px 50px', borderRadius: '50px', border: "1px solid black" }} className='btn btn-light mt-3 mx-5'>CANCEL</button>
            <button type='submit' style={{ padding: '15px 50px', borderRadius: '50px', border: "1px solid black" }} className='btn btn-primary mt-3'>SUBMIT</button>
          </form>
        </div>
        ...
        <div className="map_location mx-auto col-12 col-md-6 col-lg-6 py-5">
          <iframe
            ...
            src="https://goo.gl/maps/qe83y8hugELBGrou5?g_st=aw"
